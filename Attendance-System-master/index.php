...
<html>
 ...
 <style>
     body{
         background-color: rgba(231, 192, 221, 0.47);
     }
     table{
 ...
 <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a style="font-family: Constantia" class="navbar-brand" href="index.php">Forget the Rage</a>
        </div>
  ...
  <div class="container">
    <h2>Models & Designer interns</h2>
    <h4>For <a href="student.php">Models & Designer interns</a></h4>
    <hr>
    <h2 style="font-family:'Lucida Handwriting'">FORGET THE RAGE</h2>
    ...
    <table class="table table-bordered table-striped">
      <thead>
        <tr>
          <th>Login</th>
          <th style="font-family: Constantia">Sign Up</th>
        </tr>
      </thead>
      <tbody>
        <tr>
